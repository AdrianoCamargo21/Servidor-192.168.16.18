...
<html>
<head>
<title>Replicador Clientes Videira</title>
...
$sql="select codigo from replicadorcliente where base=1 order by codigo desc limit 1 ";echo $sql.'<br>';
...
while($dados=pg_fetch_array($exsql)){
    ...
    $com="insert into replicadorcliente(codigo,base) VALUES ($codigo,1)";echo $com.'<br>';
    ...
    $com="delete from replicadorcliente where codigo < $codigo and base = 1 ";
    $excom=pg_query($serv,$com);
    if (!$excom) {
