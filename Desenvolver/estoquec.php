...
if(!@($conexaoc=pg_connect ("host=192.168.10.190 dbname=troll_cdr port=5430 user=postgres password=ky$14gr@"))){
    echo "<p style=background:#000000; align=center <br/><b><font size=30 color=#FF0000>ERRO!!! Sem Comunicação Banco de Dados de Caçador Data: $time  Hora:$time </font></b></p>";
...
echo "<p style=background:#D3D3D3; align=center <br/><b><font size=5 color=#FF0000>Lista de Pedidos Caçador Data: $dia Hora:$time</font></b></p>";
