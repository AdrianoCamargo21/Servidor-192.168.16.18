...
<html>
<head>
<title>Replicador Base Joinville</title>
...
if(!@($destino=pg_connect ("host=127.0.0.1 dbname=troll_lj port=5435 user=postgres password=ky$14gr@"))){
    echo "<p style=background:#000000; align=center <br/><b><font size=30 color=#FF0000>ERRO!!! Sem Comunicação Banco de Dados Replicado De Joinville Data:$dia  Hora:$time </font></b></p>";
    echo "<p style=background:#000000; align=center <br/><b><font size=10 color=#7CFC00>Caso Persista Favor avisar o Adriano</font></b></p>";
    pg_close($serv);
    ?>
    <!DOCTYPE html>
...
$sql="select codigo from replicadorbase where base=3 order by codigo desc limit 1 ";
...
while($dados=pg_fetch_array($exsql)){
    ...
    $com="update replicadorbase set codigo = $codigo where base = 3";    
